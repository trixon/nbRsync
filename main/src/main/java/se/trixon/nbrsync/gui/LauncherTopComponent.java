...
import se.trixon.nbrsync.ui.editor.EditorPane;

/**
 * Top component which displays something.
 */
@ConvertAsProperties(
        dtd = "-//se.trixon.nbrsync.gui//Launcher//EN",
        autostore = false
)
...
@ActionID(category = "Window", id = "se.trixon.nbrsync.gui.LauncherTopComponent")
